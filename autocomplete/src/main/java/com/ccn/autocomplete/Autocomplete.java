 ...
 * - {@link com.ccn.beitaini.autocomplete.AutocompleteCallback}: if specified, this listens to click events and visibility changes
...
public final class Autocomplete<T> implements TextWatcher, SpanWatcher {
    ...
    public final static class Builder<T> {
        ...
        /**
         * Registers the {@link com.ccn.beitaini.autocomplete.AutocompleteCallback} to be used, responsible for listening to
     ...
     */
    public void setOffsetFromAnchor(int offset) {
    ...
    public void setOutsideTouchable(boolean outsideTouchable) {
        popup.setOutsideTouchable(outsideTouchable);
    }
